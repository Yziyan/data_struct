...
public class RBTree<E> extends BBST<E> {
    ...
    @Override
    protected void afterAdd(BinaryTreeImpl.Node<E> node) {
        BinaryTreeImpl.Node<E> parent = node.parent;
        ...
        BinaryTreeImpl.Node<E> grandparent = red(parent.parent);
        BinaryTreeImpl.Node<E> uncle = parent.sibling(); // 取出叔父节点
    ...
    @Override
    protected void afterRemove(BinaryTreeImpl.Node<E> node) {
        /*
            ①、被删除的节点是红色的情况
        ...
        */
        ...
        BinaryTreeImpl.Node<E> parent = node.parent; // 取出被删除节点的父节点
        ...
        */
        ...
        BinaryTreeImpl.Node<E> sibling = isLeft ? parent.right : parent.left;
    ...
    @Override
    protected BinaryTreeImpl.Node<E> createNode(E element, BinaryTreeImpl.Node<E> parent) {
     ...
     * 红黑树内部的节点
     */
    private static class RBNode<E> extends BinaryTreeImpl.Node<E> {
        /**
         * 节点的颜色【默认为红色】
         */
        boolean color = RED;

        public RBNode(E element, BinaryTreeImpl.Node<E> parent) {
     ...
     * @return ：被染色的节点
     */
    private BinaryTreeImpl.Node<E> color(BinaryTreeImpl.Node<E> node, boolean color) {
     ...
     * 将节点染成红色
     */
    private BinaryTreeImpl.Node<E> red(BinaryTreeImpl.Node<E> node) {
     ...
     * 将节点染成黑色
     */
    private BinaryTreeImpl.Node<E> black(BinaryTreeImpl.Node<E> node) {
     ...
     * @return ：节点的颜色
     */
    private boolean colorOf(BinaryTreeImpl.Node<E> node) {
     ...
     * 查看是否是红色的节点
     */
    private boolean isRed(BinaryTreeImpl.Node<E> node) {
     ...
     * 查看是否是黑色的节点
     */
    private boolean isBlack(BinaryTreeImpl.Node<E> node) {
